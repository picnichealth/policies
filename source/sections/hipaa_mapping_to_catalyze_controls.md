# HIPAA Mappings to PicnicHealth Controls

Below is a list of HIPAA Safeguards and Requirements and the PicnicHealth controls in place to meet those.

| **Administrative Controls** HIPAA Rule | PicnicHealth Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | PicnicHealth Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | PicnicHealth Control
---------------- | ----------------
